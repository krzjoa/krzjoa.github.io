...
// Insert a sample set of graph components
function insertSample(graph) {
  graph.getModel().beginUpdate();
  try
  {
    var v1 = graph.insertVertex(parent, null, 'Input,', 20, 20, 80, 30);
    var v2 = graph.insertVertex(parent, null, 'Output', 200, 150, 80, 30);
